...
var defaultItems = [
	...
	{name: '9. When focus blurred the record will be updated'}
];
...
function addItem(item, isNew){
	...
	row.innerHTML = "<td class='content'><textarea onchange='saveChange(this)' onkeydown='onKey(event)'></textarea></td>" +
